...
class STAR(Dataset):
    def __init__(self, args=None, tokenizer=None, split='train'):
        ...
        for i in range(len(self.data)):
            ...
            question_clip = clip_selector.tokenize(question_txt)
...
def inference(args):
    ...
    selector = Selector(topk=30, dim=768).to(torch.device(args.device))
    _ = selector.load_state_dict(torch.load('./selector_epoch9.pt'))
